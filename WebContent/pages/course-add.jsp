              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                    	<form role="form" action="do-course-add" method="post"> 
                    	<div class="form-group">
						    <label for="name">编号</label>
						    <input name="course.id"  type="text" class="form-control" id="name"  placeholder="请输入编号">
						    <label for="name"><font color="red">${err1}</font></label>
						  </div>                  
                    	  <div class="form-group">
						    <label for="name">课程名</label>
						    <input name="course.course_name" type="text" class="form-control" id="name" placeholder="请输入课程名">
						    <label for="name"><font color="red">${err2}</font></label>
						  </div>
						  <div class="form-group">
						    <label for="name">课程开设学期</label>
						    <input name="course.coursse_semester" type="text" class="form-control" id="name" placeholder="请输入课程开设学期">
