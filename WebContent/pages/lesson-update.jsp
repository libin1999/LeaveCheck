                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                    	...
                    	<div class="form-group">
						    ...
						    <input name="lesson.id" disabled="true" type="text" class="form-control" id="name" value="${lesson.id}" placeholder="请输入编号">
						    <label for="name"><font color="red">${err1}</font></label>
						  </div>
                    	  <div class="form-group">
						    <label for="name">课程编号</label>
						    <input name="lesson.course_id" type="text" class="form-control" id="name" value="${lesson.course_id}" placeholder="请输入课程编号">
						    <label for="name"><font color="red">${err2}</font></label>
						  </div>
						  <div class="form-group">
						    <label for="name">上课班级编号</label>
						    <input name="lesson.clazz_id" type="text" class="form-control" id="name" value="${lesson.clazz_id}" placeholder="请输入上课班级号">
						    <label for="name"><font color="red">${err3}</font></label>
						  </div>	
						  <div class="form-group">
						    <label for="name">上课教室</label>
						    <input name="lesson.clazz_room" type="text" class="form-control" id="name" value="${lesson.clazz_room}" placeholder="请输入上课教室">
						    <label for="name"><font color="red">${err4}</font></label>
						  </div>				
						  <div class="form-group">
						    <label for="name">上课老师</label>
						    <input name="lesson.teacher_id" type="text" class="form-control" id="name" value="${lesson.teacher_id}" placeholder="请输入上课教师">
						    <label for="name"><font color="red">${err5}</font></label>
						  </div>
						  <div class="form-group">
						    <label for="name">上课时间</label>
						    <input name="lesson.weekday" type="text" class="form-control" id="name" value="${lesson.weekday}" placeholder="请输入上课时间">
						    <label for="name"><font color="red">${err6}</font></label>
						  </div>
						  <div class="form-group">
						    <label for="name">上课开始节数</label>
						    <input name="lesson.clazz_begin" type="text" class="form-control" id="name" value="${lesson.clazz_begin}" placeholder="请输入课程开始时间">
						    <label for="name"><font color="red">${err7}</font></label>
						  </div>
						  <div class="form-group">
						    <label for="name">上课结束节数</label>
						    <input name="lesson.clazz_over" type="text" class="form-control" id="name" value="${lesson.clazz_over}" placeholder="请输入课程结束时间">
						    <label for="name"><font color="red">${err8}</font></label>
						  </div>
						  <button type="submit" class="btn btn-default" onClick="window.location.href='do-lesson-update.action'">修改</button>
                    	</form>
                    </div>
                  </div>
                </div>
