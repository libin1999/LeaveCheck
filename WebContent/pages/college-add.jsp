              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-body">
                    	<form role="form" action="do-college-add" method="post"> 
                    	<div class="form-group">
						    <label for="name">编号</label>
						    <input name="college.id"  type="text" class="form-control" id="name"  placeholder="请输入编号">
						    <label for="name"><font color="red">${err1}</font></label>
						  </div>                  
                    	  <div class="form-group">
						    <label for="name">学院名</label>
						    <input name="college.name" type="text" class="form-control" id="name" placeholder="请输入学院名">
						    <label for="name"><font color="red">${err2}</font></label>
						  </div>
						  <div class="form-group">
						    <label for="name">学院排序值</label>
						    <input name="college.sequence" type="text" class="form-control" id="name" placeholder="请输入学院排序值">
