                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                    	<table id="linkinfo" class="table table-striped">
						  ...
						  <tbody>
						  	<s:iterator value="#request.majors" var="major">
						  		<tr >
							      <td>${major.major_name }</td>
							      <td>${major.major_sequence }</td>	
							      <td>${major.major_type }</td>
							      <td>${major.major_semeters }</td>
							      <td>${major.college_id }</td>									      
							      <td>
							      	<button type="button" class="btn btn-default" onClick="window.location.href='major-update.action?id=${major.id}'">修改</button>
							      </td>
							      <td>
							      	<button type="button" class="btn btn-default" onClick="window.location.href='do-major-delete.action?id=${major.id}'">删除</button>
							      </td>
							    </tr>
						...
						<div align="center">
							<button type="button" class="btn btn-default" onClick="window.location.href='major-add.action'">添加信息</button>
						</div>
                    </div>
                  </div>
                </div>
