...
<html>
  <head>
    ...
    <!-- From treetable -->
    <link rel="stylesheet" href="res/css/treetable.css">
    <!-- Favicon-->
  ...
  <body>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center">
                      <h3 class="h4">授课信息表</h3>
                    </div>
                    <div class="card-body">
                    	<table id="lessoninfo" class="table table-striped">
						  <thead>
						    <tr>
						    <th>编号</th>
						      <th>课程编号</th>
						  ...
						  <tbody>
						  	<s:iterator value="#request.lessons" var="lesson">
						  		<tr >
						  		<td>${lesson.id }</td>
						  		  <td>${lesson.course_id }</td>
						  		  <td>${lesson.clazz_id }</td>
						  		  <td>${lesson.clazz_room }</td>
						  		  <td>${lesson.teacher_id }</td>
						  		  <td>${lesson.weekday }</td>
						  		  <td>${lesson.clazz_begin }</td>
							      <td>${lesson.clazz_over }</td>								      
							      <td>
							      	<div align="center">
								      	<button type="button" class="btn btn-default" onClick="window.location.href='lesson-update.action?id=${lesson.id}'">修改</button>
								     
								      	<button type="button" class="btn btn-default" onClick="window.location.href='do-lesson-delete.action?id=${lesson.id}'">删除</button>
							     	 </div>
							      </td>
							    </tr>
						...
						<div align="center">
							<button type="button" class="btn btn-default" onClick="window.location.href='lesson-add.action'">添加信息</button>
						</div>
                    </div>
                  </div>
                </div>
    ...
    <script src="res/js/jquery.treetable.js"></script>
    <!-- Main File-->
    <script src="res/js/front.js"></script>
    <script type="text/javascript">
    	$("#lessoninfo").treetable({expandable : true});
    </script>
